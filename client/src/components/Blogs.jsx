                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div className="h-full bg-gray-50 border border-gray-200 rounded-lg">
                            ...
                            <div className="p-8 md:p-12">
                                <h2 className="text-gray-900 text-3xl font-extrabold mb-2">Green Gadgets</h2>
                        ...
                        <div className="h-full bg-gray-50 border border-gray-200 rounded-lg">
                            ...
                            <div className="p-8 md:p-12">
                                <h2 className="text-gray-900 text-3xl font-extrabold mb-2">What Are Green Gadgets?</h2>
                        ...
                        <div className="h-full bg-gray-50 border border-gray-200 rounded-lg">
                            ...
                            <div className="p-8 md:p-12">
                                <h2 className="text-gray-900 text-3xl font-extrabold mb-2">Impact of Green Gadgets</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="h-full bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
                            <h2 className="text-gray-900 text-3xl font-extrabold mb-2">Understanding Types of E-waste</h2>
                        ...
                        <div className="h-full bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
                            <h2 className="text-gray-900 text-3xl font-extrabold mb-2">Sources of e-waste</h2>
