...
const About = () => {
    ...
    return (
        <>
            ...
            <div className="container drop-shadow-md px-5 py-10 mx-auto flex flex-wrap">
                <div className="lg:w-4/6 mx-auto">
                    <div className="flex flex-wrap w-full py-32 px-10 relative">
                        <img alt="gallery" className="w-full object-cover h-full object-center block opacity-30 absolute inset-0" src={about} />
                        <div className="text-center relative z-10 w-full">
                            <h2 className="text-5xl text-black-800 font-bold title-font mb-2">About Us</h2>
                        </div>
                    </div>
                </div>
            </div>
